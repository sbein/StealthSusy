...
template_frag = 'StealthSusy/GenFragments/Stealth_test_cff.py'
...
for masses in SinglinoSinglet_masses:
    f = open('CMSSW_8_0_5_patch1/src/Configuration/Generator/python/StealthSusy_mSinglino%dmSinglet%d_cff.py'%(masses[0], masses[1]),'w')
    for line in lines:
